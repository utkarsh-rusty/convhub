const ROWS = [
  { git: "Stores files", convhub: "Stores shared conversations & AI context" },
  { git: "Commit history", convhub: "Conversation commits, packages & restore" },
  { git: "Branches", convhub: "Conversation branches & repository memory" },
  { git: "git push / git pull", convhub: "convhub push / convhub pull (AI handoff)" },
    ...
    <section id="why-not-git" className="border-y border-[var(--color-border)] bg-[var(--color-muted)]/20 px-6 py-20 md:py-28">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-4 max-w-2xl text-[var(--color-muted-foreground)]">
          Git is perfect for code. ConvHub versions the AI collaboration context that never lived
          in a commit — then hands it to the next developer with the same push/pull habit.
        </p>
